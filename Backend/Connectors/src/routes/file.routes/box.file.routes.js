...
import * as fileValidation from '../../Validation/box.file.validation.js';
import * as fileController from '../../Controllers/box.file.controller.js';
 ...
 * /v1/box/upload:
 *   post:
 *     summary: upload a file to the Box
 *     tags: [BOX]
 *     parameters:
 *       - in: query
 *         name: folderId
 ...
 * /v1/box/delete:
 *   delete:
 *     summary: delete a file from the Box
 *     tags: [BOX]
 *     parameters:
 *       - in: query
 *         name: fileId
 ...
 * /v1/box/download:
 *   get:
 *     summary: download a file from the Box
 *     tags: [BOX]
 *     parameters:
 *       - in: query
 *         name: fileId
 ...
 * /v1/box/list:
 *   post:
 *     summary: list a file from the Box
 *     tags: [BOX]
 *     requestBody:
 *       required: true
 *       content:
 ...
 * /v1/box/read:
 *   get:
 *     summary: read a file from the Box
 *     tags: [BOX]
 *     parameters:
 *       - in: query
 *         name: fileId
